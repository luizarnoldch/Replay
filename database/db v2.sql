...
INSERT INTO `products` (`id`, `name`, `rating`, `price`, `img_url`, `category`, `descripcion`, `marca`) VALUES
	...
	(5, 'Sony Noise', 4.5, 348.00, 'https://home.ripley.com.pe/Attachment/WOP_5/2065254770831/2065254770831_2.jpg', 6, NULL, NULL),
...
-- Volcando datos para la tabla db_ihc.product_categories: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla db_ihc.sessions: ~1 rows (aproximadamente)
DELETE FROM `sessions`;
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`session_id`, `expires`, `data`) VALUES
	('ZPVsCK0RO7szo6z_adnoK_QtQIb3wMIL', 1642306336, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"flash":{}}');
